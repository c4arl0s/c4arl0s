...
1. [x] [readmefy.sh: Generates a table of contents from a text file.](https://github.com/c4arl0s/readmefy)
2. [x] [note.sh: Command-line tool for creating and browsing notes using standard input and fzy.](https://github.com/c4arl0s/note#note)
3. [x] [git-add-ui.sh: Uses a dialog box to add modified and untracked files to the staging area.](https://github.com/c4arl0s/git-add-user-interface-script#git-add-user-interface-script)
4. [x] [lookup.sh: Retrieves English/Spanish word translations; created during my student days.](https://github.com/c4arl0s/lookup)
5. [x] [addword.sh: Included in the lookup repository.](https://github.com/c4arl0s/lookup)
6. [x] [statusfy: Reminds me if a repository has modified or untracked files.](https://github.com/c4arl0s/statusfy)
7. [x] [ffmpg-mov-to-mp4.sh: Converts a .mov file to .mp4 using the file's full path as a parameter.](https://github.com/c4arl0s/ffmpg-mov-to-mp4)
8. [x] [dscleaner.sh: Removes .DS_Store files recursively.](https://github.com/c4arl0s/dscleaner)
9. [x] [pdf2imgx.sh: Extracts images from a PDF file recursively.](https://github.com/c4arl0s/pdf2imgx)
10. [x] [rename.sh: Renames all files and directories in the current directory recursively.](https://github.com/c4arl0s/rename)
11. [x] [git-branch-delete-ui.sh: Uses a user interface to delete Git branches.](https://github.com/c4arl0s/git-branch-delete-ui)
12. [x] [git-add-with-filter-ui.sh: Uses a dialog box to filter and add modified or untracked files to the staging area.](https://github.com/c4arl0s/git-add-with-filter-ui#git-add-with-filter-ui)
13. [x] [git-restore-ui.sh: Uses a dialog box to restore files from the staging area.](https://github.com/c4arl0s/git-restore-user-interface-script#git-restore-user-interface-script)
14. [x] [git-restore-with-filter-ui.sh: Uses a dialog box to restore filtered files from the staging area.](https://github.com/c4arl0s/git-restore-with-filter-ui)
15. [x] [git-status-with-filter.sh: Shows the status of files filtered by extension.](https://github.com/c4arl0s/git-status-with-filter?tab=readme-ov-file#git-status-with-filter)
16. [x] [git-diff-with-filter.sh: Shows file differences filtered by extension.](https://github.com/c4arl0s/git-diff-with-filter?tab=readme-ov-file#git-diff-with-filter)
17. [x] [rm.sh: Overrides the standard rm command to prevent accidental deletion; it deletes only one file at a time, moving it to the .Trash directory.](https://github.com/c4arl0s/rm)
